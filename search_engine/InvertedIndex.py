...
def create_index(path):
    global partialIndex, docIDMap, docIDdict, lexicon, fingerprints
    nltk.download("punkt")
...
def savePartialIndex():
    ...
    f = open("Data/InvertedIndex.txt", "a+")
...
def save_globals():
    global docIDMap, lexicon, docIDdict

    with open("Data/DocIDMap.txt", "wb+") as f:
        pickle.dump(docIDMap, f)

    with open("Data/Lexicon.txt", "wb+") as f:
        pickle.dump(lexicon, f)

    with open("Data/DocIDdict.txt", "wb+") as f:
        pickle.dump(docIDdict, f)
